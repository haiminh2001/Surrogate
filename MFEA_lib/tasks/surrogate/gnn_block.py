...
class MyGATConv(MessagePassing):
    ...
    def forward(self, x, edge_index,
        ...
        alpha, edge_attr = self.edge_updater(edge_index, alpha=alpha, edge_attr=edge_attr)
    ...
    def edge_update(self, alpha_j, alpha_i: OptTensor,
                    edge_attr, index: Tensor, ptr: OptTensor,
                    size_i) -> Tensor:
